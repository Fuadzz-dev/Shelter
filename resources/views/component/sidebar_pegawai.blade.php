...
>
    ...
    <div class="flex flex-1 flex-col gap-1 overflow-y-auto">
        ...
        <!-- Tab 3: Profil Saya -->
        <a
            class="font-label-md text-label-md mx-2 my-1 flex items-center gap-3 rounded-lg px-3 py-2 transition-colors duration-200 {{ request()->routeIs('pegawai.profil') ? 'bg-secondary-container text-on-secondary-container shadow-sm' : 'text-on-primary/70 hover:bg-white/10 hover:text-white' }}"
