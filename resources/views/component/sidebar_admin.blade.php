<!-- ========================================================================= -->
<!-- START: KOMPONEN SIDEBAR ADMIN (Responsif: Desktop + Mobile Drawer) -->
<!-- ========================================================================= -->
...
@php
    ...
    $adminNavCtaRoute = route('admin.laporan-helpdesk.create');
@endphp
...
>
    ...
    <div class="flex flex-1 flex-col gap-1 overflow-y-auto">
        @include('component.nav_links_admin')
    </div>
