        ...
        <main class="px-gutter py-stack-lg mx-auto w-full max-w-5xl flex-grow">
            ...
            <div class="mb-stack-lg flex items-start justify-between">
                <div>
                    ...
                    >
                        Isi formulir di bawah untuk melaporkan masalah atau permintaan layanan IT. 
                    </p>
                </div>
...
<form action="{{ route('pegawai.laporan-helpdesk.store') }}" method="POST" enctype="multipart/form-data" class="gap-stack-md flex flex-col">
                        @csrf
