    ...
    <body class="text-on-surface bg-background">
        ...
        <div class="flex min-h-screen">
            ...
            <main class="ml-[280px] flex-1">
                <div class="p-container-padding mx-auto max-w-4xl py-12">
                    <!-- Flash Messages -->
                    @if (session('success'))
...
<!-- Profile Image Card -->
                        <div
                            class="paperless-card flex flex-col items-center gap-6 rounded-xl p-10"
                        >
                            <div class="group relative">
                                <img
                                    id="profileImagePreview"
                                    class="border-surface-container h-36 w-36 rounded-full border-4 object-cover shadow-sm"
                                    alt="Foto Profil"
                            ...
                            <p class="text-outline font-label-sm text-label-sm">
                                Klik ikon kamera untuk mengubah foto profil (JPG, PNG, WEBP — maks 2MB)
                            </p>
                        </div>
