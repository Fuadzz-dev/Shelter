...
<div class="flex flex-col gap-4">
                            <div>
                                ...
                                >
                                    {{ $laporan->riwayat->first()->pelapor->nama_lengkap ?? $laporan->riwayat->first()->pelapor->name ?? $laporan->persetujuanDigital->first()->penyetuju->nama_lengkap ?? $laporan->persetujuanDigital->first()->penyetuju->name ?? '-' }}
                                </p>
                            </div>
                            <div>
                                <p
                                ...
                                <p
                                    class="text-body-lg font-body-lg text-on-surface font-semibold"
                                >
                                    {{ $laporan->riwayat->first()->pelapor->jabatan_departemen ?? $laporan->persetujuanDigital->first()->penyetuju->jabatan_departemen ?? '-' }}
                                </p>
                            </div>
                            <div>
                                <p
...
<!-- Verification URL (hidden, used to generate QR) -->
            <input type="hidden" id="verification-url" value="{{ url('/verifikasi-admin/'.$laporan->nomor_Helpdesk) }}" />
